...
A particularly relevant question in the IUPAC Blue Book (link) at the time of writing pertains to the naming of the ionic side chain NH3+, commonly named ammonium. The IUPAC Blue book names the methylammoium (CH3NH3+) cation "methanaminium". However, in other contexts, the NH3+ side chain is termed "azanium" (example), leading to some ambiguity in the naming schemes for related molecular ion species. We did notice that the (NIST) database of molecular species appears to adopt the term "aminium" instead of "azanium" and we follow the same convention here for IUPAC style names:
